...
import com.sluv.backoffice.domain.comment.service.CommentService;
...
public class CommentDashBoardController {
    ...
    public ResponseEntity<SuccessDataResponse<CommentBlockCountResDto>> getCommentBlockCount() {

        return ResponseEntity.ok().body(
                SuccessDataResponse.<CommentBlockCountResDto>builder()
                        .result(commentService.getCommentBlockCount())
                        .build()
        );
    }
