...
@NoArgsConstructor
@Builder
public class CommentBlockCountResDto {
    ...
    public static CommentBlockCountResDto of(Long totalCount, Long recentMonthCount, List<Long> countGraph) {
        return CommentBlockCountResDto.builder()
